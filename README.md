...
| 4 | **Azure Security Baseline & Policy Alerts** |Establishes a complete Azure security baseline by integrating Microsoft Defender for Cloud, Microsoft Cloud Security Benchmark (MCSB), and centralized logging. Configures diagnostic settings, policy enforcement, and automated email alerts for continuous compliance and threat visibility. | 
